...
public class TestBluePrints {
	...
	public static void main(String[] args) {
		...
		Vertex k = graph.addVertex(null);
		a.setProperty("name", "marko");
		b.setProperty("name", "peter");
		c.setProperty("name", "kim");
		d.setProperty("name", "doo");
		k.setProperty("name", "won");
		Edge e = graph.addEdge(null, a, b, "knows");
		Edge e2 = graph.addEdge(null, a, c, "knows");
		Edge e3 = graph.addEdge(null, a, k, "knows3");
		Edge e4 = graph.addEdge(null, a, d, "knows4");
